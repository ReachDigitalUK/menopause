...
class FreeResources
{
    ...
    public static function registerPostType(): void
    {
        ...
        \register_extended_post_type(self::SLUG, [
            ...
            'enter_title_here' => 'Free Resources Name',
            'supports' => [
                'title',
                'editor',
                'excerpt',
            ...
            'singular' => \__('Free Resources', 'reach'),
            'plural'   => \__('Free Resources', 'reach'),
            'slug'     => self::SLUG,
        ]);
    }
    ...
    public static function addSettingsPage(): void
    {
        ...
        \acf_add_options_sub_page([
            'page_title'  => \__('Free Resources Settings', 'reach'),
            'menu_title'  => \__('Free Resources Settings', 'reach'),
            'menu_slug'   => 'acf-options-free-resource-settings',
