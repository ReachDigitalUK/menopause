        ...
        <div class="swiper cards-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="swiper_inner review-card">
                        ...
                        <a href='<?= $card['author_url'] ?>'><img class='google-icon'
                                src='/wp-content/themes/reach/assets/images/icons/google.svg' /></a>
                    </div>
                </div>
                <?php } ?>
            </div>
                ...
                <div class="swiper-slide post-card">
                    <div class="swiper_inner--post">
                        ...
                        <div class="post-image-container">
                            <img class="post-image" src="<?= esc_url($card['post_image']); ?>"
                                alt="<?= esc_attr($post->post_title); ?>" />
                            <!-- <?php //$categories = get_the_category($post->ID); $category_name = (!empty($categories) && isset($categories[0]->name)) ? esc_html($categories[0]->name) : 'No Category';?><div class="post-category"><?php // $category_name; ?></div> -->
                        </div>
                        <!-- Content -->
