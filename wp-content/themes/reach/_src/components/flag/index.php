<section <?= \Reach\Helpers::buildAttributes($args['attributes']); ?>>
    <div class="flag__inner <?php if (!empty($args['add_classes'])) {
        echo $args['add_classes'];
                            }; ?>">
        <div class="flag__layout">
            ...
            <div class="flag__layout__content">
                ...
                <<?php echo isset($args['heading_type']) ? $args['heading_type'] : 'h2'; ?>>
                    <?= $args['heading']['heading'] ?>
                </<?php echo isset($args['heading_type']) ? $args['heading_type'] : 'h2'; ?>> <?php
                } ?>
                ...
                <div class="flag__layout__content__bullets <?php if (isset($args['flag_type'])) {
                    if ($args['flag_type'] === 'package') {
                        echo 'bullet-one-column';
                    }
                                                           }; ?>">
                    <div class="column">
                        <ul>
                ...
                <div class="flag__layout__content__button">
                    <a href="<?= $args['button']['url']; ?>"
                        class="<?= $args['button_class'];?>"><?= $args['button']['title']; ?></a>
                </div>
                <?php } ?>
            </div>
        </div>
